...
# MFA ####
# loading data ####
MFA <- fread("C:\\Users\\Seller_King\\Downloads\\OL.txt")

# filters and prelims (new items) ####
colnames(MFA)[13] <- "item_condition"
MFA <- MFA %>%
  filter(item_condition %in% c(1, 2, 5))
...
# analysis ####
# keepa data
MFA_info <- read.csv("C:\\Users\\Seller_King\\Downloads\\ULN_mfa.csv")
...
write.xlsx(price_disc_MFA, "C:\\Users\\Seller_King\\Desktop\\MFA_price_disc_ULN.xlsx")
...
FBA <- FBA %>%
  filter(!`Quantity Available` == 0 & condition == "UsedLikeNew") 
...
# analysis ####
# keepa data
FBA_info <- read.csv("C:\\Users\\Seller_King\\Downloads\\ULN_fba.csv")
...
write.xlsx(price_disc_FBA, "C:\\Users\\Seller_King\\Desktop\\FBA_price_disc_ULN.xlsx")
